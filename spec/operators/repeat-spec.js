...
describe('repeat operator', function () {
    ...
    it('should always teardown before starting the next cycle', function () { return __awaiter(void 0, void 0, void 0, function () {
        var results, source;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    chai_1.expect(results).to.deep.equal([1, 2, 'teardown', 1, 2, 'teardown', 1, 2, 'teardown']);
                    return [2];
            }
        });
    }); });
    it('should always teardown before starting the next cycle, even when synchronous', function () {
        ...
        chai_1.expect(results).to.deep.equal([1, 2, 'teardown', 1, 2, 'teardown', 1, 2, 'complete', 'teardown']);
    });

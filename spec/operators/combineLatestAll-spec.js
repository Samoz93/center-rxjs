...
describe('combineLatestAll operator', function () {
    ...
    it('should handle selector throwing', function () {
        testScheduler.run(function (_a) {
            ...
            var e2subs = '     ^--!';
            var expected = '   ---#';
            var result = rxjs_1.of(e1, e2).pipe(operators_1.combineLatestAll(function (x, y) { throw 'ha ha ' + x + ', ' + y; }));
    ...
    it('should combine two observables', function (done) {
        ...
        rxjs_1.of(a, b).pipe(operators_1.combineLatestAll()).subscribe({ next: function (vals) {
    ...
    it('should combine two immediately-scheduled observables', function (done) {
        ...
        rxjs_1.of(a, b, rxjs_1.queueScheduler).pipe(operators_1.combineLatestAll())
            .subscribe({ next: function (vals) {

...
describe('concatAll operator', function () {
    ...
    it('should concat sources from promise', function (done) {
        ...
        var res = [];
        sources.pipe(operators_1.concatAll()).subscribe({ next: function (x) {
                res.push(x);
            }, error: function (err) {
    ...
    it('should finalize before moving to the next observable', function () {
        ...
        rxjs_1.of(create(1), create(2), create(3)).pipe(operators_1.concatAll()).subscribe({
    ...
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        rxjs_1.of(synchronousObservable).pipe(operators_1.concatAll(), operators_1.take(3)).subscribe(function () { });

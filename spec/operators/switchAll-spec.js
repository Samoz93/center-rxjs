...
describe('switchAll', function () {
    ...
    it('should not leak when child completes before each switch (prevent memory leaks #2355)', function () {
        ...
        chai_1.expect((_b = (_a = sub._teardowns) === null || _a === void 0 ? void 0 : _a[0]._teardowns) === null || _b === void 0 ? void 0 : _b.length).to.equal(1);
        sub.unsubscribe();
    });
    it('should not leak if we switch before child completes (prevent memory leaks #2355)', function () {
        ...
        chai_1.expect((_b = (_a = sub._teardowns) === null || _a === void 0 ? void 0 : _a[0]._teardowns) === null || _b === void 0 ? void 0 : _b.length).to.equal(1);
        chai_1.expect((_c = sub._teardowns) === null || _c === void 0 ? void 0 : _c.length).to.equal(2);
        sub.unsubscribe();
    });

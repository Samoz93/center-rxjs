...
describe('single operator', function () {
    ...
    it('should call predicate with indices starting at 0', function () {
        rxTest.run(function (_a) {
            ...
            expectObservable(e1.pipe(operators_1.single(predicate), operators_1.tap({ complete: function () {
    ...
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.single()).subscribe({ next: function () { }, error: function () { } });

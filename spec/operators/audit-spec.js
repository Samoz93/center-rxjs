...
describe('audit operator', function () {
    ...
    it('should audit by promise resolves', function (done) {
        ...
        e1.pipe(operators_1.audit(function () { return Promise.resolve(42); })).subscribe({ next: function (x) {
    ...
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.audit(function () { return rxjs_1.of(0); }), operators_1.take(3)).subscribe(function () { });

...
describe('catchError operator', function () {
    ...
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        rxjs_1.throwError(function () { return new Error('Some error'); }).pipe(operators_1.catchError(function () { return synchronousObservable; }), operators_1.takeWhile(function (x) { return x != 2; })).subscribe(function () { });
    ...
    it('should pass the error as the first argument', function (done) {
        rxjs_1.throwError(function () { return ('bad'); }).pipe(operators_1.catchError(function (err) {
    ...
    it('should accept selector returns any ObservableInput', function (done) {
        ...
        input$.pipe(operators_1.mergeMap(function (input) {
            return rxjs_1.throwError(function () { return ('bad'); }).pipe(operators_1.catchError(function (err) { return input; }));
    ...
    context('fromPromise', function () {
        ...
        it('should chain a throw from a promise using Observable.throw', function (done) {
            ...
            rxjs_1.from(Promise.reject(testError)).pipe(operators_1.catchError(function (err) {
                return rxjs_1.throwError(function () { return (thrownError); });
    ...
    it('Properly handle async handled result if source is synchronous', function (done) {
        ...
        var values = [];
        source.pipe(operators_1.catchError(function (err) { return sourceWithDelay; }))
            .subscribe({ next: function (value) { return values.push(value); }, error: function (err) { return done(err); }, complete: function () {
    ...
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.catchError(function () { return rxjs_1.EMPTY; }), operators_1.take(3)).subscribe(function () { });

...
describe('concatMapTo', function () {
    ...
    it('should map values to constant resolved promises and concatenate', function (done) {
        ...
        var results = [];
        source.pipe(operators_1.concatMapTo(rxjs_1.from(Promise.resolve(42)))).subscribe({ next: function (x) {
                results.push(x);
            }, error: function (err) {
    ...
    it('should map values to constant rejected promises and concatenate', function (done) {
        var source = rxjs_1.from([4, 3, 2, 1]);
        source.pipe(operators_1.concatMapTo(rxjs_1.from(Promise.reject(42)))).subscribe({ next: function (x) {

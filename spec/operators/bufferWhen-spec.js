...
describe('bufferWhen operator', function () {
    ...
    it('should NOT handle synchronous inner', function (done) {
        ...
        source.pipe(operators_1.bufferWhen(function () { return closing; }), operators_1.takeWhile(function (val, index) { return index < TOO_MANY_INVOCATIONS; })).subscribe({ next: function (val) {

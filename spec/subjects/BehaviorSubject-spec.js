...
describe('BehaviorSubject', function () {
    ...
    it('should replay the previous value when subscribed', function () {
        ...
        var expected3 = '                           8---9--|';
        marble_testing_1.expectObservable(marble_testing_1.hot(sourceTemplate).pipe(operators_1.tap({ next: feedNextIntoSubject, error: feedErrorIntoSubject, complete: feedCompleteIntoSubject }))).toBe(sourceTemplate);

...
describe('SafeSubscriber', function () {
    ...
    it('should close, unsubscribe, and unregister all teardowns after complete', function () {
        ...
        chai_1.expect(subscription_1.getRegisteredTeardowns(subscriber).length).to.equal(0);
    });
    it('should close, unsubscribe, and unregister all teardowns after error', function () {
...
describe('Subscriber', function () {
    it('should teardown and unregister all teardowns after complete', function () {
        var isTornDown = false;
    ...
    describe('deprecated next context mode', function () {
        ...
        it('should allow changing the context of `this` in a POJO subscriber', function () {
            ...
            chai_1.expect(results).to.deep.equal([0, 1, 2, 3, 'teardown']);
        });
        it('should NOT break this context on next methods from unfortunate consumers', function () {
            var CustomConsumer = (function () {
                function CustomConsumer() {

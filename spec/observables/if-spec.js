...
describe('iif', function () {
    ...
    it('should accept resolved promise as thenSource', function (done) {
        var expected = 42;
        var e1 = rxjs_1.iif(function () { return true; }, new Promise(function (resolve) { resolve(expected); }), rxjs_1.of());
    ...
    it('should accept rejected promise as thenSource', function (done) {
        var expected = 42;
        var e1 = rxjs_1.iif(function () { return true; }, new Promise(function (resolve, reject) { reject(expected); }), rxjs_1.of());
        e1.subscribe({ next: function (x) {
                done(new Error('should not be called'));
            }, error: function (x) {
                chai_1.expect(x).to.equal(expected);

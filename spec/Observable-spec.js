...
describe('Observable', function () {
    ...
    describe('subscribe', function () {
        ...
        it('should teardown even with a synchronous thrown error', function () {
            var called = false;
        ...
        describe('if config.useDeprecatedSynchronousErrorHandling === true', function () {
            ...
            it('should teardown even with a synchronous error', function () {
                var called = false;
                var badObservable = new rxjs_1.Observable(function (subscriber) {
                    subscriber.add(function () {
                        called = true;
            ...
            it('should execute finalize even with a sync error', function () {
                var called = false;
                var badObservable = new rxjs_1.Observable(function (subscriber) {
                    subscriber.error(new Error('bad'));
            ...
            it('should call teardown if sync unsubscribed', function () {
                var called = false;
            ...
            it('should call registered teardowns if sync unsubscribed', function () {
                var called = false;

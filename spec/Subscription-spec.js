...
describe('Subscription', function () {
    describe('add()', function () {
        ...
        it('should unsubscribe a teardown function that was passed', function () {
            var isCalled = false;
            var main = new rxjs_1.Subscription();
            main.add(function () {
                isCalled = true;
        ...
        it('should unsubscribe a teardown function that was passed immediately if it has been unsubscribed', function () {
            var isCalled = false;
            var main = new rxjs_1.Subscription();
            main.unsubscribe();
            main.add(function () {
    ...
    describe('unsubscribe()', function () {
        ...
        it('should unsubscribe from all parents', function () {
            ...
            b.add(d);
            c.add(d);
            chai_1.expect(a._teardowns).to.have.length(1);
            chai_1.expect(b._teardowns).to.have.length(1);
            chai_1.expect(c._teardowns).to.have.length(1);
            d.unsubscribe();
            chai_1.expect(a._teardowns).to.have.length(0);
            chai_1.expect(b._teardowns).to.have.length(0);
            chai_1.expect(c._teardowns).to.have.length(0);
        });
    });
});
